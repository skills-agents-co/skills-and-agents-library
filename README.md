...
| **Automate AP invoice intake** -- scan inbox, extract fields, dedupe, log for review, forward to AP system. Never approves, never pays. | [`ap-invoice-processing/`](./ap-invoice-processing) | skill |
