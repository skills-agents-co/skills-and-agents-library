...
Use `listTransactions` with date range filtering for the last 60 days. Mercury's MCP handles pagination automatically — let it run until all transactions are retrieved.
